...
class PolarCoordTest {
    ...
    void relative_coords_between_two_points_radii_should_be_equal_and_theta_should_differ_by_PI(
        ...
        if (p1.equals(p2)) {
            ...
            assertThat("Relative coord between equal points should be (0,0)", fromP1ToP2, is(equalTo(new PolarCoord(0.0, 0.0))));
        } else {
    ...
    private static double MAX_RADIUS = sqrt(pow(72, 2) + pow(72, 2));
