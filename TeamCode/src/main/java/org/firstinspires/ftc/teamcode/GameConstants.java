...
public class GameConstants {
    ...
    public static final FieldPosition FACING_IMAGE_FRONT_WALL_RED = fieldPosition(50, PI, FACING_FRONT_WALL);
    public static final FieldPosition FACING_IMAGE_RED_WALL_FRONT = fieldPosition(36, PI, FACING_RED_WALL);
