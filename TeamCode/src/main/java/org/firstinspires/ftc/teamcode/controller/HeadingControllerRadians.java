 ...
 */
public class HeadingControllerRadians implements Controller<Double, Double, Double> {
    private double zero;
     ...
     */
    public HeadingControllerRadians(
    ...
    static double calcAngularProportion(double err) {
        return (NaN == err) ? NaN : (1.0-Math.abs((err-PI)/PI))*signum(err-PI);
    }
