...
//FOUNDATION SIDE START
    ...
    public static final Map<Integer, List<FieldPosition>> redSkystoneLocations = new HashMap<Integer, List<FieldPosition>>(){{
        put(1, asList(fieldPosition(xy(-64, -37), FACING_BLUE_WALL), fieldPosition(xy(-64, -14), FACING_BLUE_WALL), fieldPosition(xy(-64, -40), FACING_BLUE_WALL)));
        put(2, asList(fieldPosition(xy(-56, -37), FACING_BLUE_WALL), fieldPosition(xy(-56, -14), FACING_BLUE_WALL), fieldPosition(xy(-56, -40), FACING_BLUE_WALL)));
        put(3, asList(fieldPosition(xy(-48, -37), FACING_BLUE_WALL), fieldPosition(xy(-48, -14), FACING_BLUE_WALL), fieldPosition(xy(-48, -40), FACING_BLUE_WALL)));
        put(4, asList(fieldPosition(xy(-40, -37), FACING_BLUE_WALL), fieldPosition(xy(-40, -14), FACING_BLUE_WALL), fieldPosition(xy(-40, -40), FACING_BLUE_WALL)));
        put(5, asList(fieldPosition(xy(-32, -37), FACING_BLUE_WALL), fieldPosition(xy(-32, -14), FACING_BLUE_WALL), fieldPosition(xy(-32, -40), FACING_BLUE_WALL)));
        put(6, asList(fieldPosition(xy(-25, -37), FACING_BLUE_WALL), fieldPosition(xy(-24, -14), FACING_BLUE_WALL), fieldPosition(xy(-24, -40), FACING_BLUE_WALL)));
    ...
    public static final Map<Integer, List<FieldPosition>> blueSkystoneLocations = new HashMap<Integer, List<FieldPosition>>(){{
        put(1, asList(fieldPosition(xy(-64, 37), FACING_RED_WALL), fieldPosition(xy(-64, 14), FACING_RED_WALL), fieldPosition(xy(-64, 40), FACING_RED_WALL)));
        put(2, asList(fieldPosition(xy(-56, 37), FACING_RED_WALL), fieldPosition(xy(-56, 14), FACING_RED_WALL), fieldPosition(xy(-56, 40), FACING_RED_WALL)));
        put(3, asList(fieldPosition(xy(-48, 37), FACING_RED_WALL), fieldPosition(xy(-48, 14), FACING_RED_WALL), fieldPosition(xy(-48, 40), FACING_RED_WALL)));
        put(4, asList(fieldPosition(xy(-40, 37), FACING_RED_WALL), fieldPosition(xy(-40, 14), FACING_RED_WALL), fieldPosition(xy(-40, 40), FACING_RED_WALL)));
        put(5, asList(fieldPosition(xy(-32, 37), FACING_RED_WALL), fieldPosition(xy(-32, 14), FACING_RED_WALL), fieldPosition(xy(-32, 40), FACING_RED_WALL)));
        put(6, asList(fieldPosition(xy(-25, 37), FACING_RED_WALL), fieldPosition(xy(-24, 14), FACING_RED_WALL), fieldPosition(xy(-24, 40), FACING_RED_WALL)));
    }};
}
